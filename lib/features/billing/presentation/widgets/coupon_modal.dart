  ...
  Widget build(BuildContext context) {
    return Consumer3<LocalProductProvider, AppSettingsProvider,
      ...
      builder: (context, localProductProvider, appSettingsProvider,
        ...
        final isMobileCoupon = MediaQuery.of(context).size.width < 600;

        final leftColumnContent = SingleChildScrollView(
          child: Column(
        ...
        final rightColumnContent = SingleChildScrollView(
          child: Column(
            children: [
              Container(
                padding:
