...
class AuthModel extends ChangeNotifier {
  ...
  String? get token {
    ...
    if (_token != null) {
      debugPrint("🔧 AuthModel: token present: ${_token?.isNotEmpty == true}");
    }
    return _token;
  }
  ...
  void login(String token, int userId) {
    debugPrint(
        "🔧 AuthModel: login called with userId: $userId, token exists: ${token.isNotEmpty}");
    ...
    debugPrint(
        "✅ AuthModel: Login successful - isLoggedIn: $_isLoggedIn, userId: $_userId");
  ...
  void logout() {
    ...
    debugPrint(
        "🔧 AuthModel: Previous state - isLoggedIn: $_isLoggedIn, userId: $_userId");
    ...
    debugPrint(
        "✅ AuthModel: Logout successful - isLoggedIn: $_isLoggedIn, userId: $_userId");
