class APPUrl {
  ...
  static String get updateQuotationStatus =>
      '$baseURL/api/v1/quotations/update-status';
  static String get convertQuotationToOrder =>
      '$baseURL/api/v1/quotations/convert-to-order';
  static String get listProformaInvoices =>
      '$baseURL/api/v1/invoice/proforma-invoices';
  static String viewProformaInvoice(dynamic id) =>
      '$baseURL/api/v1/invoice/proforma-invoices/$id';

  static String get loginUrl => '$baseURL/api/v1/user/signin';
  static String get companySubscriptionStatus =>
      '$baseURL/api/v1/company/subscription-status';
  ...
  static String get deleteProductUrl =>
      '$baseURL/api/v1/product/delete-product';
  ...
  static String get stockReportUrl => '$baseURL/api/v1/stock-report';
  ...
  static String get openShift => '$baseURL/api/v1/daily-sales-close/open';
