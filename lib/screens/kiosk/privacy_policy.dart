  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'legal.privacy_policy.page_title'.tr,
    ...
    return SingleChildScrollView(
      ...
      child: BuildBoxShadowContainer(
        ...
        child: Column(
          ...
          children: [
            Text(
              'legal.privacy_policy.heading'.tr,
              style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 16),
            Text(
              'legal.privacy_policy.label_last_updated'.tr,
              style: const TextStyle(fontSize: 14, fontStyle: FontStyle.italic),
            ),
            const SizedBox(height: 16),
            Text(
              'legal.privacy_policy.section_introduction'.tr,
            ...
            const Divider(),
            Text(
              'legal.privacy_policy.section_info_collect'.tr,
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
            ...
            const Divider(),
            Text(
              'legal.privacy_policy.section_how_use'.tr,
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
            ...
            const Divider(),
            Text(
              'legal.privacy_policy.section_disclosure'.tr,
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
            ...
            const Divider(),
            Text(
              'legal.privacy_policy.section_security'.tr,
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
            ...
            const Divider(),
            Text(
              'legal.privacy_policy.section_rights'.tr,
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
            ...
            const Divider(),
            Text(
              'legal.privacy_policy.section_changes'.tr,
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
            ...
            const Divider(),
            Text(
              'legal.privacy_policy.section_contact'.tr,
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text(
