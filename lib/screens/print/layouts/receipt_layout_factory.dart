...
class ReceiptLayoutFactory {
  ...
  static ReceiptLayout getLayout(String? activeTheme) {
    ...
    debugPrint('[ReceiptLayoutFactory] Unknown theme "$themeKey", falling back to classic');
  ...
  static void registerLayout(String themeId, ReceiptLayout Function() layoutFactory) {
